...
public class Ejercicios {
	...
	public static void sumaDigitos(int valor) {
		...
		ToolsPanel.imprimePantalla("Suma de digitos: "+suma);
	}
	...
	public static void Triangulo(int filas) {
		...
		ToolsPanel.imprimePantalla(cadena);
	}
	...
	public static void cuentaVocales(String cadena) {
		...
		ToolsPanel.imprimePantalla("Frecuencia de vocales\n"+cad);
	}
	
	public static void mayorNum(int dato1,int dato2,int dato3) {
		int a =Math.max(dato1,dato2);
		ToolsPanel.imprimePantalla("El número mayor es: "+(Math.max(a, dato3)));
	}
